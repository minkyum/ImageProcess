...
for(i in 1:365){
  ...
  url <- paste('https://e4ftl01.cr.usgs.gov/MOLA/MYD11A1.006/',year,'.',mm,'.',dd,'/',sep='')
  
  system(paste('wget --user=mkmoon --password=M159k258! -l1 -r --no-parent -A "MYD11A1.A',year,d_str,'.',tile,'.006.*.hdf" ',url,sep=''))    
